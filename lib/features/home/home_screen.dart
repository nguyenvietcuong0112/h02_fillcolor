...
class _ImageCard extends StatefulWidget {
  ...
  const _ImageCard({super.key, required this.image, required this.onTap});
    ...
    try {
      ...
      if (boundary is RenderRepaintBoundary) {
        ...
        if (byteData != null) {
          ...
          final file = await ThumbnailHelper.saveThumbnail(
            widget.image.id,
            bytes,
          );
            ...
            Expanded(
              child: Hero(
                ...
                child: _thumbnailFile != null
                    ? Image.file(_thumbnailFile!, fit: BoxFit.contain)
                    : FutureBuilder(
