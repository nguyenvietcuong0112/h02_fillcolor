...
/// Global navigator key for top-level navigation and ad overlays
final GlobalKey<NavigatorState> rootNavigatorKey = GlobalKey<NavigatorState>();

/// Main application widget
class FillColorApp extends ConsumerStatefulWidget {
  const FillColorApp({Key? key}) : super(key: key);

  @override
  ConsumerState<FillColorApp> createState() => _FillColorAppState();
}



class _FillColorAppState extends ConsumerState<FillColorApp> {
  @override
  void initState() {
    super.initState();
    AppInitializer.init();
