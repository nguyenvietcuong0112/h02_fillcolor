...
class GeminiSketchService {
  /// Convert photo to clean coloring outline purely using Gemini AI Vision API
  static Future<Uint8List?> convertToSketchWithGemini(
    ...
    if (apiKey.isEmpty) {
      debugPrint('Gemini API Key is empty. Please set gemini_api_key in Firebase Remote Config.');
      return null;
    }
