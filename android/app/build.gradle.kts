...
android {
    namespace = "com.fillcolor.coloringbook.paint.colorart"
    ...
    defaultConfig {
        ...
        applicationId = "com.fillcolor.coloringbook.paint.colorart"
        // You can update the following values to match your application needs.
        // For more information, see: https://flutter.dev/to/review-gradle-config.
        minSdk = flutter.minSdkVersion // Required for AdMob
